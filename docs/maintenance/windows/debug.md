...
## 1. visual c++ 20xx redistributable 安装
更新日期：2024-07-26  
...
setx PATH "%PATH%;C:\Progra~1\Java\jdk1.8.0_121in;C:\Progra~1\Java\jdk1.8.0_121\jrein"
# setx表示配置永久环境变量
# set表示在当前cmd配置环境变量
...
# Path 
%JAVA_HOME%in;%JAVA_HOME%\jrein;
```


## 5. Windows10-开机自启Chrome，全屏打开指定网站
``` shell
